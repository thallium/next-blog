---
title: "CodeForces 813E - Army Creation 题解"
...
考虑询问$(l, r)$，对于$i\in [l, r]$，如果$b_i\le r$，说明$i$后$a_i$出现了多于$k$次，所以$i$不应该在军队里。所以答案是$r-l+1-|\{b_i|b_i\le r, i\in[l, r]\}|$。找区间里小于$x$的数的个数可以用主席树或者 wavelet 树解决。
